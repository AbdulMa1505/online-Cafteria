    ...
    <section class="ftco-intro">
    	<div class="container-wrap">
    		<div class="wrap d-md-flex align-items-xl-end">
	    		...
	    		<div class="book p-4">
	    			<h3>Book a Table</h3>
	    			<form action="<?php echo APPURL; ?>/booking/book.php" method="post" class="appointment-form">
	    				<div class="d-md-flex">
    	...
    	<div class="container">
        	...
        	<div class="row">
				<?php foreach( $allProducts as $singleProduct): ?>
					<div class="col-md-3">
						<div class="menu-entry">
								<a  href="<?php echo APPURL; ?>/images/<?php echo $singleProduct->image;?>" class="img" style="background-image: url(<?php echo APPURL; ?>/images/<?php echo $singleProduct->image; ?>);"></a>
								<div class="text text-center pt-4">
									<h3><a href="#"><?php echo $singleProduct->name;?></a></h3>
									<p><?php echo $singleProduct->description;?></p>
									<p class="price"><span>$<?php echo $singleProduct->price;?></span></p>
									<p><a target="_blank" href="<?php echo APPURL; ?>/products/product-single.php?id=<?php echo $singleProduct->product_id;?>" class="btn btn-primary btn-outline-primary">Show</a></p>
								</div>
						</div>
